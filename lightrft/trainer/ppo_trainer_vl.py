...
class PPOTrainerVL(ABC):
    ...
    def __init__(
        ...
        **generate_kwargs,
        ...
        # Configure policy loss for GMPO / GSPO / CPGD
        ...
        if use_gmpo:
            self.strategy.print(
                f"[PPOTrainerVL] GMPO enabled: advantage_estimator='{getattr(self.args, 'advantage_estimator', None)}'"
            )
        if use_gspo:
            self.strategy.print(
                f"[PPOTrainerVL] GSPO enabled: advantage_estimator='{getattr(self.args, 'advantage_estimator', None)}'"
            )
